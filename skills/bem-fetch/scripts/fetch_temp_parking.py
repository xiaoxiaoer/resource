...
使用方式：
    python3 fetch_temp_parking.py --car-park "车场名称" [--date-range "2025-05~2026-04"]
"""
...
def fetch_temp_parking_data(car_park: str, date_range: str | None = None) -> dict:
    ...
    raise NotImplementedError("BEM 临停收入数据获取脚本待实现")
...
def main():
    ...
    try:
        result = fetch_temp_parking_data(args.car_park, args.date_range)
